...
export default function BuildingBridgesScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Content */}
      {phase === 'home' && (
        <ScrollView style={styles.scrollView} contentContainerStyle={[styles.scrollContent, { paddingBottom: BAR_HEIGHT + 60 }]} showsVerticalScrollIndicator={false} onScroll={handleScroll} scrollEventThrottle={16}>
          <HomeView
            homeTab={homeTab}
