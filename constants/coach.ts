 ...
 * "Nuance" — warm, wise, grounded relationship guide.
 */

export const COACH = {
  name: 'Nuance',
  tagline: 'Your Relationship Guide',
  avatar: '\u2726', // ✦ sparkle — subtle, elegant, nuanced understanding
  greeting:
    "Hi, I\u2019m Nuance \u2014 your relationship guide. I\u2019m here to listen, reflect, and walk alongside you. What\u2019s on your mind?",
  personality: {
