...
export const COMPATIBILITY_DIMS = [
  { key: 'attunement', label: 'Attunement', desc: 'How naturally you sense each other', icon: 'attunement', color: Colors.primary },
  { key: 'co_creation', label: 'Creative Tension', desc: 'How your differences generate sparks', icon: 'tension', color: Colors.accentGold },
  { key: 'space', label: 'Space', desc: 'Room for both of you to breathe', icon: 'space', color: Colors.secondary },
  { key: 'growth', label: 'Growth Direction', desc: "Where you're both heading", icon: 'growth', color: Colors.success },
  { key: 'resilience', label: 'Resilience', desc: "How you'd weather storms together", icon: 'resilience', color: Colors.accent },
];
