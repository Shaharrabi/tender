/**
 * InsightCarousel — a horizontal scrolling carousel of insight cards.
 *
 ...
 * navigates to the insight's actionRoute when available.
...
export default function InsightCarousel({ insights }: InsightCarouselProps) {
      ...
      >
        {insights.map((insight) => (
          <Pressable
            ...
            style={({ pressed }) => [
              styles.card,
              insight.actionRoute ? styles.cardTappable : undefined,
              pressed && insight.actionRoute ? styles.cardPressed : undefined,
            ]}
