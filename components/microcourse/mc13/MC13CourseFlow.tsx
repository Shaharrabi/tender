/**
 * MC13CourseFlow — Orchestrator for "Fondness & Gratitude".
 *
 * Follows MC10 CourseFlow architecture: interactive -> transition -> reflection
 * 5 heartfelt lessons: Magic Ratio, Memory Excavation, Appreciation Matcher,
 * Appreciation Sprint, Appreciation Letter.
 */
...
import { MC13ProgressHeader } from './MC13ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import L1MagicRatioSlider from './lessons/L1MagicRatioSlider';
import L2MemoryExcavation from './lessons/L2MemoryExcavation';
import L3AppreciationMatcher from './lessons/L3AppreciationMatcher';
import L4AppreciationSprint from './lessons/L4AppreciationSprint';
import L5AppreciationLetter from './lessons/L5AppreciationLetter';
...
export function MC13CourseFlow({ lessonNumber, totalLessons, attachmentStyle, content, lesson, course, onComplete, onExit, onPreviousLesson, saving }: MC13CourseFlowProps) {
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1: return <L1MagicRatioSlider {...commonProps} />;
      case 2: return <L2MemoryExcavation {...commonProps} />;
      case 3: return <L3AppreciationMatcher {...commonProps} />;
      case 4: return <L4AppreciationSprint {...commonProps} />;
      case 5: return <L5AppreciationLetter {...commonProps} />;
      default: return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC13ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
