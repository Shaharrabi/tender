/**
 * MC3 Progress Header — shows 5 lesson icons for "From Rupture to Repair".
 * Completed = success color, Current = amber accent, Future = muted outline.
...
const LESSON_ICONS = [LightbulbIcon, ShieldIcon, ChatBubbleIcon, PenIcon, HeartDoubleIcon];
const LESSON_LABELS = [
  'Myths',
  'Horsemen',
  'Scenario',
...
interface MC3ProgressHeaderProps {
...
export function MC3ProgressHeader({ currentLesson, totalLessons, onExit, onPreviousLesson }: MC3ProgressHeaderProps) {
  return (
...
const styles = StyleSheet.create({
  ...
  connectorCurrent: {
    backgroundColor: MC3_PALETTE.amber + '60',
  },
  node: {
    width: 32,
    height: 32,
