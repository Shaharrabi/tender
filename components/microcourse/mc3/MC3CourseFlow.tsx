/**
 * MC3CourseFlow — Orchestrator for "From Rupture to Repair".
 *
 * Follows MC1/MC2 CourseFlow's exact architecture:
...
import { MC3ProgressHeader } from './MC3ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import { L1MythBusterCards } from './lessons/L1MythBusterCards';
import { L2HorsemanMatcher } from './lessons/L2HorsemanMatcher';
import { L3RepairScenario } from './lessons/L3RepairScenario';
import { L4RepairSentenceBuilder } from './lessons/L4RepairSentenceBuilder';
import { L5RitualDesigner } from './lessons/L5RitualDesigner';
...
export function MC3CourseFlow({
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1:
        return <L1MythBusterCards {...commonProps} />;
      case 2:
        return <L2HorsemanMatcher {...commonProps} />;
      case 3:
        return <L3RepairScenario {...commonProps} />;
      case 4:
        return <L4RepairSentenceBuilder {...commonProps} />;
      case 5:
        return <L5RitualDesigner {...commonProps} />;
      default:
        return null;
    }
  };
