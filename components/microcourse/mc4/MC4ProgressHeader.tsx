/**
 * MC4 Progress Header — shows 5 lesson icons for "Boundaries That Connect".
 * Completed = success color, Current = teal accent, Future = muted outline.
...
const LESSON_ICONS = [ScaleIcon, ShieldIcon, ChatBubbleIcon, CompassIcon, LightbulbIcon];
const LESSON_LABELS = [
  'Spectrum',
  'Sort',
  'Transform',
...
interface MC4ProgressHeaderProps {
...
export function MC4ProgressHeader({ currentLesson, totalLessons, onExit, onPreviousLesson }: MC4ProgressHeaderProps) {
  return (
...
const styles = StyleSheet.create({
  ...
  connectorCurrent: {
    backgroundColor: MC4_PALETTE.teal + '60',
  },
  node: {
    width: 32,
    height: 32,
