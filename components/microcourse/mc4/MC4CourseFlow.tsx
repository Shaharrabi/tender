/**
 * MC4CourseFlow — Orchestrator for "Boundaries That Connect".
 *
 * Follows MC1/MC2/MC3 CourseFlow's exact architecture:
...
import { MC4ProgressHeader } from './MC4ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import { L1BoundarySpectrum } from './lessons/L1BoundarySpectrum';
import { L2ThreeColumnSort } from './lessons/L2ThreeColumnSort';
import { L3SentenceTransformer } from './lessons/L3SentenceTransformer';
import { L4ScenarioCarousel } from './lessons/L4ScenarioCarousel';
import { L5ReframeGallery } from './lessons/L5ReframeGallery';
...
export function MC4CourseFlow({
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1:
        return <L1BoundarySpectrum {...commonProps} />;
      case 2:
        return <L2ThreeColumnSort {...commonProps} />;
      case 3:
        return <L3SentenceTransformer {...commonProps} />;
      case 4:
        return <L4ScenarioCarousel {...commonProps} />;
      case 5:
        return <L5ReframeGallery {...commonProps} />;
      default:
        return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC4ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
