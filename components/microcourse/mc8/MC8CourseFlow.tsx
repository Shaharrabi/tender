/**
 * MC8CourseFlow — Orchestrator for "Boundaries Deep: The Body Knows".
 *
 * Follows MC1-MC6 CourseFlow architecture: interactive -> transition -> reflection
 * 5 somatic/body lessons: Body Boundary Map, Cost-Gain Timeline,
 * Embodied Scenario, Statement Builder, Holding Ground Sim.
 */
...
import { MC8ProgressHeader } from './MC8ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import { L1BodyBoundaryMap } from './lessons/L1BodyBoundaryMap';
import L2CostGainTimeline from './lessons/L2CostGainTimeline';
import L3EmbodiedScenario from './lessons/L3EmbodiedScenario';
import L4StatementBuilder from './lessons/L4StatementBuilder';
import L5HoldingGroundSim from './lessons/L5HoldingGroundSim';
...
export function MC8CourseFlow({ lessonNumber, totalLessons, attachmentStyle, content, lesson, course, onComplete, onExit, onPreviousLesson, saving }: MC8CourseFlowProps) {
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1: return <L1BodyBoundaryMap {...commonProps} />;
      case 2: return <L2CostGainTimeline {...commonProps} />;
      case 3: return <L3EmbodiedScenario {...commonProps} />;
      case 4: return <L4StatementBuilder {...commonProps} />;
      case 5: return <L5HoldingGroundSim {...commonProps} />;
      default: return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC8ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
