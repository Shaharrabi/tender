/**
 * MC1CourseFlow — Orchestrator for the interactive MC1 course.
 *
 * Replaces the generic Read/Exercise/Reflection flow with unique
 * interactive components per lesson, followed by a shared reflection step.
 */
...
import { MC1ProgressHeader } from './MC1ProgressHeader';
import { LessonTransition } from './LessonTransition';
import { L1OriginWiring } from './lessons/L1OriginWiring';
import { L2SomaticHeatmap } from './lessons/L2SomaticHeatmap';
import { L3CycleBuilder } from './lessons/L3CycleBuilder';
import { L4PatternBreaker } from './lessons/L4PatternBreaker';
import { L5BlueprintContract } from './lessons/L5BlueprintContract';
...
export function MC1CourseFlow({
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1:
        return <L1OriginWiring {...commonProps} />;
      case 2:
        return <L2SomaticHeatmap {...commonProps} />;
      case 3:
        return <L3CycleBuilder {...commonProps} />;
      case 4:
        return <L4PatternBreaker {...commonProps} />;
      case 5:
        return <L5BlueprintContract {...commonProps} />;
      default:
        return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC1ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
