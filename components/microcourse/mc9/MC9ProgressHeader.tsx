/**
 * MC9 Progress Header — playful progress bar for "The Lightness Lab".
 * Uses sunshine/playful theme icons and colors.
 */
...
const LESSON_ICONS = [SparkleIcon, HeartPulseIcon, CoupleIcon, WindIcon, FlagIcon];
const LESSON_LABELS = [
  'Bid Spotter',
  'Temperature',
  'Play Styles',
...
interface MC9ProgressHeaderProps {
...
export function MC9ProgressHeader({ currentLesson, totalLessons, onExit, onPreviousLesson }: MC9ProgressHeaderProps) {
  return (
