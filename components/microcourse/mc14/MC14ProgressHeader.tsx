/**
 * MC14 Progress Header — slate-themed progress bar for "Trust Repair".
 * Uses grounded icons and slate/gold accent colors.
 */
...
const LESSON_ICONS = [SearchIcon, ScaleIcon, CalendarIcon, ChatBubbleIcon, FlagIcon];
const LESSON_LABELS = [
  'Anatomy',
  'Atonement',
  'Timeline',
...
interface MC14ProgressHeaderProps {
...
export function MC14ProgressHeader({ currentLesson, totalLessons, onExit, onPreviousLesson }: MC14ProgressHeaderProps) {
  return (
...
const styles = StyleSheet.create({
  ...
  connectorCurrent: { backgroundColor: '#4A6B8A' + '60' },
  ...
  nodeCurrent: { backgroundColor: '#4A6B8A', borderColor: '#4A6B8A' },
