/**
 * MC14CourseFlow — Orchestrator for "Trust Repair".
 *
 * Follows MC10 CourseFlow architecture: interactive -> transition -> reflection
 * 5 deep lessons: Betrayal Anatomy, Atonement Sorter, Rebuild Timeline,
 * Repair Conversation, 90-Day Rebuild Plan.
 */
...
import { MC14ProgressHeader } from './MC14ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import L1BetrayalAnatomy from './lessons/L1BetrayalAnatomy';
import L2AtonementSorter from './lessons/L2AtonementSorter';
import L3RebuildTimeline from './lessons/L3RebuildTimeline';
import L4RepairConversation from './lessons/L4RepairConversation';
import L5RebuildPlan from './lessons/L5RebuildPlan';
...
export function MC14CourseFlow({ lessonNumber, totalLessons, attachmentStyle, content, lesson, course, onComplete, onExit, onPreviousLesson, saving }: MC14CourseFlowProps) {
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1: return <L1BetrayalAnatomy {...commonProps} />;
      case 2: return <L2AtonementSorter {...commonProps} />;
      case 3: return <L3RebuildTimeline {...commonProps} />;
      case 4: return <L4RepairConversation {...commonProps} />;
      case 5: return <L5RebuildPlan {...commonProps} />;
      default: return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC14ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
