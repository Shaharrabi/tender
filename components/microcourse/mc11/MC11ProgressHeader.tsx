/**
 * MC11 Progress Header — shows 5 lesson icons for "Orientation to Pleasure".
 * Completed = success color, Current = warm gold accent, Future = muted outline.
...
const LESSON_ICONS = [SunIcon, CompassIcon, SparkleIcon, MeditationIcon, FlagIcon];
const LESSON_LABELS = [
  'Myth Shatter',
  'Sensory Hunt',
  'Pleasure Palette',
...
interface MC11ProgressHeaderProps {
...
export function MC11ProgressHeader({ currentLesson, totalLessons, onExit, onPreviousLesson }: MC11ProgressHeaderProps) {
  return (
...
const styles = StyleSheet.create({
  ...
  connectorCurrent: {
    backgroundColor: MC11_PALETTE.warmGold + '60',
  },
  node: {
    width: 32,
    height: 32,
  ...
  nodeCurrent: {
    backgroundColor: MC11_PALETTE.warmGold,
    borderColor: MC11_PALETTE.warmGold,
  },
  nodeFuture: {
    backgroundColor: 'transparent',
    borderColor: Colors.border,
