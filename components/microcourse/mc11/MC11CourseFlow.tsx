/**
 * MC11CourseFlow — Orchestrator for "Orientation to Pleasure".
 *
 * Follows MC6 CourseFlow's exact architecture:
 *   interactive -> transition -> reflection
 *
 * Based on Organic Intelligence (OI) — warm, dreamy, sensory-rich.
 * Helps users orient toward pleasant experiences and build pleasure capacity.
 */
...
import { MC11ProgressHeader } from './MC11ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import { L1MythShatterCards } from './lessons/L1MythShatterCards';
import L2SensoryTreasureHunt from './lessons/L2SensoryTreasureHunt';
import L3PleasurePaletteBuilder from './lessons/L3PleasurePaletteBuilder';
import L4PleasantIntensityPractice from './lessons/L4PleasantIntensityPractice';
import L5OrientationRitualBuilder from './lessons/L5OrientationRitualBuilder';
...
export function MC11CourseFlow({
  lessonNumber,
  totalLessons,
  attachmentStyle,
  content,
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1:
        return <L1MythShatterCards {...commonProps} />;
      case 2:
        return <L2SensoryTreasureHunt {...commonProps} />;
      case 3:
        return <L3PleasurePaletteBuilder {...commonProps} />;
      case 4:
        return <L4PleasantIntensityPractice {...commonProps} />;
      case 5:
        return <L5OrientationRitualBuilder {...commonProps} />;
      default:
        return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC11ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
