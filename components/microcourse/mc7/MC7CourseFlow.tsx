/**
 * MC7CourseFlow — Orchestrator for "The Text Between Us".
 *
 * Follows MC1-MC6 CourseFlow architecture:
 *   interactive -> transition -> reflection
 *
 * 5 phone/text-themed lessons: Reaction Test, Tone Decoder,
 * Text Lab, Attachment Decoder, Conversation Sim.
 */
...
import { MC7ProgressHeader } from './MC7ProgressHeader';
import { LessonTransition } from '../mc1/LessonTransition';
import { L1ReactionTest } from './lessons/L1ReactionTest';
import L2ToneDecoder from './lessons/L2ToneDecoder';
import L3TextLab from './lessons/L3TextLab';
import L4AttachmentDecoder from './lessons/L4AttachmentDecoder';
import L5ConversationSim from './lessons/L5ConversationSim';
...
export function MC7CourseFlow({
  ...
  const renderInteractive = () => {
    ...
    switch (lessonNumber) {
      case 1:
        return <L1ReactionTest {...commonProps} />;
      case 2:
        return <L2ToneDecoder {...commonProps} />;
      case 3:
        return <L3TextLab {...commonProps} />;
      case 4:
        return <L4AttachmentDecoder {...commonProps} />;
      case 5:
        return <L5ConversationSim {...commonProps} />;
      default:
        return null;
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <MC7ProgressHeader currentLesson={lessonNumber} totalLessons={totalLessons} onExit={onExit} onPreviousLesson={onPreviousLesson} />
