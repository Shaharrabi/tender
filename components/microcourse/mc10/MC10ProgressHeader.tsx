/**
 * MC10 Progress Header — intimate-themed progress bar for "Seen".
 * Uses deep violet accent colors and knowledge/connection icons.
 */
...
const LESSON_ICONS = [CompassIcon, EyeIcon, SearchIcon, PenIcon, FlagIcon];
const LESSON_LABELS = [
  'Knowledge Map',
  'Observation',
  'Question Deck',
...
interface MC10ProgressHeaderProps {
...
export function MC10ProgressHeader({ currentLesson, totalLessons, onExit, onPreviousLesson }: MC10ProgressHeaderProps) {
  return (
...
const styles = StyleSheet.create({
  ...
  connectorCurrent: { backgroundColor: '#6A5ACD' + '60' },
  ...
  nodeCurrent: { backgroundColor: '#6A5ACD', borderColor: '#6A5ACD' },
