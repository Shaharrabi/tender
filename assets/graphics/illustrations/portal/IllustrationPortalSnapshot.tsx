  ...
  return (
    <View nativeID={containerId}>
      <Svg viewBox="0 0 300 240" width={width} height={resolvedHeight} style={style}>
        ...
        <SvgText x="126" y="202" textAnchor="middle" fontSize="11" fill="#C8923A" opacity={.8} fontFamily="Georgia,serif">vitality</SvgText>
        <Circle cx="150" cy="178" r="14" fill="#7A9E8E" opacity={.55}/>
        <SvgText x="150" y="202" textAnchor="middle" fontSize="11" fill="#2A5040" opacity={.8} fontFamily="Georgia,serif">resonance</SvgText>
        <Circle cx="174" cy="182" r="10" fill="#7CA4B8" opacity={.5}/>
        <SvgText x="174" y="202" textAnchor="middle" fontSize="11" fill="#1E3A52" opacity={.8} fontFamily="Georgia,serif">coping</SvgText>
        <Rect x="20" y="20" width="260" height="16" rx="5" fill="#7A9E8E" opacity={.15}/>
        <SvgText x="150" y="31" textAnchor="middle" fontSize="11" fill="#2A5040" opacity={.8} fontFamily="Georgia,serif">{"shared strengths: depth \u00B7 loyalty \u00B7 intensity"}</SvgText>
        <SvgText x="20" y="220" fontSize="11" fill="#8B7355" opacity={.6} fontFamily="Georgia,serif">your story: two people who feel deeply, whose</SvgText>
        <SvgText x="20" y="234" fontSize="11" fill="#8B7355" opacity={.6} fontFamily="Georgia,serif">longing for closeness keeps teaching them how.</SvgText>
        <SvgText x="150" y="252" textAnchor="middle" fontFamily="Georgia,serif" fontSize="12" letterSpacing="2" fill="#2C2C2A" opacity={.5}>YOUR RELATIONSHIP IN 60 SECONDS</SvgText>
      </Svg>
    </View>
  );
}
