...
<text x="240" y="326" text-anchor="middle" font-family="Georgia,serif" font-size="10" letter-spacing="4" fill="#2C2C2A" opacity="0.45">GROUNDING · 5-4-3-2-1</text>
    ...
    */
    ...
    <Svg viewBox="0 0 480 340" width={width} height={resolvedHeight} style={style}>
      ...
      <G><Circle cx="310" cy="110" r="6" fill="none" stroke="#C8923A" strokeWidth="0.9"/><SvgText x="310" y="114" textAnchor="middle" fontSize="7" fill="#C8923A" opacity={0.7} fontFamily="Georgia,serif">see</SvgText></G>
      <G><Path d="M338 144 Q342 138 346 144 Q342 150 338 144Z" fill="#7A9E8E" opacity={0.75}/><SvgText x="342" y="160" textAnchor="middle" fontSize="7" fill="#7A9E8E" opacity={0.6} fontFamily="Georgia,serif">touch</SvgText></G>
      <G><Path d="M355 90 Q362 84 368 90" fill="none" stroke="#7CA4B8" strokeWidth="1.1" strokeLinecap="round"/><SvgText x="362" y="106" textAnchor="middle" fontSize="7" fill="#7CA4B8" opacity={0.6} fontFamily="Georgia,serif">hear</SvgText></G>
      <G><Ellipse cx="388" cy="128" rx="7" ry="5" fill="#8B7355" opacity={0.3}/><SvgText x="388" y="142" textAnchor="middle" fontSize="7" fill="#8B7355" opacity={0.55} fontFamily="Georgia,serif">smell</SvgText></G>
      <G><Circle cx="378" cy="168" r="4" fill="#D4909A" opacity={0.55}/><SvgText x="378" y="182" textAnchor="middle" fontSize="7" fill="#D4909A" opacity={0.6} fontFamily="Georgia,serif">taste</SvgText></G>
      <SvgText x="240" y="326" textAnchor="middle" fontFamily="Georgia,serif" fontSize="10" letterSpacing="4" fill="#2C2C2A" opacity={0.45}>{"GROUNDING \u00B7 5-4-3-2-1"}</SvgText>
    </Svg>
  );
}
